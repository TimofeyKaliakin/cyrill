...
В репозитории:
- ссылка на датасет и правила формирования сплитов,
...
1. Собрать и опубликовать датасет рукописной кириллицы.
2. Зафиксировать воспроизводимые правила формирования train/test.
3. Реализовать модульный пайплайн аугментаций для HTR/OCR.
4. Протестировать модели распознавания и сравнить качество по CER/WER и скорости.
